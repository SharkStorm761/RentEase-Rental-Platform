      ...
      <div className="bg-white border p-6 rounded-2xl shadow-sm space-y-4">
        ...
        <form onSubmit={handleCheckout} className="space-y-3 text-xs font-bold text-gray-500">
          <div>
            ...
            <input type="tel" required maxLength="10" pattern="[0-9]{10}" className="w-full p-2.5 border rounded-lg bg-gray-50/50 text-gray-900 text-sm font-mono font-bold outline-none focus:border-indigo-600 transition" value={phone} onChange={e => setPhone(e.target.value.replace(/\D/g, ''))} />
          </div>
